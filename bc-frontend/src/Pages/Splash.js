...
function Splash({ users, handleChange, handleSubmit, login, loggedIn } ) {
  return (
    <div>
    ...
    <Login users={users} handleChange={handleChange} handleSubmit={handleSubmit} login={login} loggedIn={loggedIn} />
    <br/><br/>
